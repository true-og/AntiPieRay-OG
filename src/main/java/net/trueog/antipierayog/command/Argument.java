...
public record Argument<T>(boolean isFlag, boolean isSwitch, String name, String[] aliases, Parser<T> parser,
        boolean isRequired) {
    ...
    public interface Parser<T> {
        ...
        // Attempts to complete the given input.
        void complete(List<String> output, String input);
